...
int main() {
  ...
  drop.addLabel(L"麦克风阵列", sf::Color(240, 240, 240), sf::Color(230, 230, 230), sf::Color(220, 220, 220));
  drop.addLabel(L"logic microphone", sf::Color(240, 240, 240), sf::Color(230, 230, 230), sf::Color(220, 220, 220));
  drop.addLabel(L"麦克风", sf::Color(240, 240, 240), sf::Color(230, 230, 230), sf::Color(220, 220, 220));
  drop.setShow(true);
