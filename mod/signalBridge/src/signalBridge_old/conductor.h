...
public:
//    Conductor(std::shared_ptr<ConnectEngine> connect);
    Conductor(std::shared_ptr<ConnectEngine> connect);
    ~Conductor();
...
//    std::string filterSDP(const std::string& sdp, bool audioflag,bool videoflag);

    std::shared_ptr<ConnectEngine> connect = nullptr;
//    ConnectEngine* connect = nullptr;
