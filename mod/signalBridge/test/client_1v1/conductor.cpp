...
Conductor::Conductor(std::shared_ptr<oatpp::websocket::WebSocket> socket_, long long sessionId_, long long handleId_)
        : socket(socket_), session_id(sessionId_), handle_id(handleId_) {}
...
void Conductor::OnIceCandidate(const webrtc::IceCandidateInterface *candidate) {
    ...
    I_LOG("trickle Req: {}", trickle.dump(4));
    oatpp::String trickleJson = oatpp::String(trickle.dump());
    socket->sendOneFrame(true, oatpp::websocket::Frame::OPCODE_TEXT, trickleJson);
