...
namespace rtcengine {
    ...
    class Janitor :public rtcengine::JLObserver {
    public:
    ...
    private:
        ...
        std::shared_ptr<rtcengine::JanitorListener> listener = nullptr;
        ...
        std::atomic<bool> reconnection = false;
    ...
    protected:
        ...
        void OnWebrtcup() override;
        void OnMedia() override;
